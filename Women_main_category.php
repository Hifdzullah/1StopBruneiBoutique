...
<body>
<?php include_once("Women_shop_by_category.php");?>
			<h2><center>Women Instant Chiffon (Hijab)</center></h2>
				<div class="mx-auto">
					<div class="row">
						<div class="card">
							<a style="color:#000000" href="Women_Product_details.php">
								<img src="Landing_Page_Image/hijab box 1.jpg" alt="Hijab" style="width:100%">					 
								<p>Women Instant Chiffon</p>
...
<?php include_once("footer_women_category_page.php"); } ?>
