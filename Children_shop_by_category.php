...
@media only screen and (max-width: 300px) {
  .prev, .next,.text {font-size: 11px}
    ...
    <body>
		...
		<div id="breadcrumb">
			<ul class="breadcrumb">
			  <li><a href="Children_main_page.php">Home</a></li>
			  <li>Children(4-7yrs)</li>
			</ul>
		</div> 
		<!--breadcrumb-->
		
		<div class="h2_container">
			<h2 class ="custom_h2">SHOP BY CATEGORY (BOY AGES 4-7YRS)</h2>
        </div>
		<div class="parent">
			<div class="column1">			
				<form>
					<div class="cd-filter-block">
						...
						<ul class="cd-filter-content cd-filters list" style="margin-left:25px">
							<li>
								<label class="radio-label" for="radio1"><a href ="Children_main_category.php" rel="page">Baju Melayu</a></label>
							</li>
							<li>
								<label class="radio-label" for="radio2"><a href="Children_second_row_list.php" rel="page">T-shirts</a></label>
							</li>
							<li>
								<label class="radio-label" for="radio3"><a href="Children_third_row_list.php" rel="page">Shirts</a></label>
							</li>
						</ul> 
					</div> 
				</form>
