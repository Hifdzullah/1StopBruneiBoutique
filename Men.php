  ...
  .prev, .next,.text {font-size: 11px}
    ...
    <body>
		...
		<div class="topnav">
			  ...
			  <a class="actinav" href="#Men-page">Men</a>
		  ...
		  <div class="mx-auto">
			...
			<br>
				 ...
				 <button class="btn">SHOP NOW</button>
				  <img src="Men_Page_Image/Men_banner.png" style="width:100%">
		...
		<div class="container">
			<div class="mx-auto">
			  <div class="row">
				<div class="col-sm-4">
				  <img src="Men_Page_Image/Dresses box 1.jpg" style="width:260px; height:310px">
				  <button class="btn"><a style="color:#000000" href="Men_main_category.php">TOPS</a></button>
				  
				</div>
				<div class="col-sm-4">
				  <img src="Men_Page_Image/bottom box 2.jpg" style="width:260px; height:310px">
				  <button class="btn"><a style="color:#000000" href="#">BOTTOMS</a></button>
				</div>
				<div class="col-sm-4">      
				  <img src="Men_Page_Image/shoes and bag box 3 .jpg" style="width:260px; height:310px">
				  <button class="btn"><a style="color:#000000" href="#">SHOES & BAGS</a></button>
				</div>
				<br>
				<div class="col-sm-4" style="padding-top:50px;">  
				  <img src="Men_Page_Image/activewear box 4.jpg" style="width:260px; height:310px">
				  <button class="btn"><a style="color:#000000" href="Shopping_cart.php">ACTIVEWEARS</a></button>
				</div>
			  </div>
			</div>
		</div>
		...
		<div class="menu-1">
		  <a href ="Men_main_page.php" rel="page">Sales</button>
		  <a href="Men_trending.php" rel="page">Trending Now</a>
		  <a href="Men_new_arrival.php" rel="page">New Arrival</a>
		</div>
