...
<body>
<?php include_once("Shop_by_category.php");?>
			<h2><center>All Product(Tops)</center></h2>
				<div class="mx-auto">
					<div class="row">
						<div class="card">
							<a style="color:#000000" href="Men_Product_details.php">
								<img src="Men_Page_Image/mibboxone.jpg" alt="Baju Melayu" style="width:100%">
								  <p>Men Fit Baju Melayu</p>
								  <p class="price">$20.00</p>
								  <p>Available size: L, XL</p>
							</a>
						  <p><button><a style="color:#ffffff" href="Shopping_cart.php">Add to Cart</a></button></p>
						</div>
						<div class="card">
							<a style="color:#000000" href="Men_Product_details.php">
								<img src="Men_Page_Image/mibboxone.jpg" alt="Baju Melayu" style="width:100%">
...
<?php include_once("footer_men_category_page.php"); } ?>
