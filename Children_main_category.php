...
<body>
<?php include_once("Children_shop_by_category.php");?>
		
			<h2><center>Children Baju Melayu</center></h2>
				<div class="mx-auto">
					<div class="row">
						<div class="card">
							<a style="color:#000000" href="Children_Product_details.php">
							  <img src="Children_Page_Image/Children box 1.jpg" alt="Baju Melayu" style="width:100%">
								  <p>Modern style cara melayu</p>
						...
						<div class="card">
							<a style="color:#000000" href="Children_Product_details.php">
							  <img src="Children_Page_Image/Children box 1.jpg" alt="aju Melayu" style="width:100%">
								  <p>Modern style cara melayu</p>
								  <p class="price">$20.00</p>
							</a>
						 <p><button><a style="color:#ffffff" href="Shopping_cart.php">Add to Cart</a></button></p>
...
<?php include_once("footer_children_category_page.php"); } ?>
