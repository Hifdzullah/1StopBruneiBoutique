    ...
    <body>
        <div class="border">
			    ...
			    <!--outter-->
					...
					<!---div right-->
					<div style="width:50%; "><h1>1Stop Brunei Boutique</h1>
					</div>
					<!---div left-->
					<div style="border: 0px solid; width:25%;">
		...
		<div id="breadcrumb">
			<ul class="breadcrumb">
			  <li><a href="Men_main_page.php">Home</a></li>
			  <li>Men(Tops)</li>
			</ul>
		</div>
				...
				<form>
					<div class="cd-filter-block">
						...
						<ul class="cd-filter-content cd-filters list" style="margin-left:25px">
							<li>
								<label class="radio-label" for="radio1"><a href ="Men_main_category.php" rel="page">All</a></label>
							</li>
							<li>
								<label class="radio-label" for="radio2"><a href="Men_second_row_list.php" rel="page"> Men Baju Melayu</a></label>
							</li>
							<li>
								<label class="radio-label" for="radio3"><a href="Men_third_row_list.php" rel="page">Men Shirts</a></label>
							</li>
						</ul> 
					</div> 
				</form>
