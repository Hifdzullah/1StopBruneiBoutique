...
@media only screen and (max-width: 300px) {
  .prev, .next,.text {font-size: 11px}
    ...
    <body>
		...
		<!-- Navigation-->
		<div class="topnav">
			  <a class="actinav" href="#home">Women</a>
		  ...
		  <div class="mx-auto">
			...
			<br>
				 ...
				 <button class="btn">SHOP NOW</button>
				  <img src="Landing_Page_Image/Women_hijab_banner.jpg" style="width:100%">
		...
		<div class="container">
			<div class="mx-auto">
			  <div class="row">
				<div class="col-sm-4">
				 ...
				 <button class="btn"><a style="color:#000000" href="Women_main_category.php">HIJABS</a></button>
				</div>
				<div class="col-sm-4">
				  <img src="Landing_Page_Image/dresses box 2.jpg" style="width:260px; height:310px">
		 ...
		 <div id="body" style=" padding-bottom:50px;" >
			<div class="menu-1">
			  <a href ="index.php" rel="page">Sales</button>
			  <a href="trending-now.php" rel="page">Trending Now</a>
			  <a href="new-arrival.php" rel="page">New Arrival</a>
			</div>
